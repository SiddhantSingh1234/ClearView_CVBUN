...
// //import News from './models/News.js'; // Adjust the path as needed
...
// //   try {
// //     // Fetch relevant data from MongoDB (e.g., news topics)
// //     const newsData = await News.find({
// //       $text: { $search: question },
// //     });

// //     // Use Groq API to generate a response
// //     const prompt = `Based on the following news data: ${JSON.stringify(newsData)}, answer this question: ${question}`;
...
//   try {
//     // Fetch relevant news articles from MongoDB using a $text search on title and content
//     const newsArticles = await News.find(
//       { $text: { $search: question } },
//       { score: { $meta: 'textScore' } } // Sort by relevance
//     ).sort({ score: { $meta: 'textScore' } }).limit(5); // Limit to 5 most relevant articles

//     console.log('Fetched News Articles:', newsArticles);

//     // Prepare the prompt for Groq API using title and content
